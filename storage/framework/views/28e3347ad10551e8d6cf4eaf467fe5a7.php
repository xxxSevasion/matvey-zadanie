...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="w-full flex items-center justify-between">
            ...
            <a href="<?php echo e(route('settings.create')); ?>" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center"><?php echo e(__('Новые настройки')); ?></a>
        </div>
         <?php $__env->endSlot(); ?>
...
<?php $component = ProtoneMedia\Splade\Components\Table::resolve(['for' => $setting] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                <?php $__env->slot('spladeTableCell418c5509e2171d55b0aee5c2ea4442b5', function ($setting) use ($__env) { ?>
                <div class="flex gap-2">
                    <Link href="<?php echo e(route('settings.destroy', $setting->id)); ?>" class="" confirm="Внимание!" confirm-text="Вы действительно хотите удалить запись?" confirm-button="Да" cancel-button="Отмена" method="DELETE"><?php echo e(__('Удалить')); ?></Link>
                    <Link  href="<?php echo e(route('settings.edit', $setting->id)); ?>">Редактировать</Link>
                </div>
                <?php }); ?>
...
<?php endif; ?>
<?php /**PATH C:\OSPanel\domains\matvey-zadanie\matvey-zadanie\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>